...
class Plots:
    ...
    @staticmethod
    def daily_tracks_graph(df: pd.DataFrame, ax):
    ...
    @staticmethod
    def track_playtime_kde_dist(df: pd.DataFrame, ax_0, ax_1):
        ...
        ax_0.set_title("KDE distribution of track playtimes (over minute)")
        ax_0.axvline(
        ...
        ax_1.set_title("KDE distribution of track playtimes (under minute)")
        ax_1.set_xlabel("Minutes")
        ax_1.axvline(
    ...
    @staticmethod
    def daily_listening_activity(df: pd.DataFrame, ax):
        hour_df = df.copy()
