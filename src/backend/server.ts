...
export const analyzedDataFolder = path.resolve(DIRPATH, "..", "..", "analysis");
console.log(`Analyzed Data Folder ${analyzedDataFolder}`);
...
app.use("/analysis", express.static(analyzedDataFolder));
